...
Lunarglow is an open source client for [Sunshine](https://github.com/LizardByte/Sunshine) and NVIDIA GameStream for embedded Linux systems, like Raspberry Pi, CuBox-i and ODROID. Lunarglow allows you to stream your full collection of games and applications from your PC to other devices to play them remotely.
...
More information about the upstream project is available on the [Moonlight Embedded wiki](https://github.com/moonlight-stream/moonlight-embedded/wiki).
